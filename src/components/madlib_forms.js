        ...
        <Row style={{textAlign: 'center', color: 'white'}}>
            ...
            <Col md="3" className="inputWrapper">
                <Row>
                    ...
                    <Col md="10">
                        <input placeholder='Adjective' type='text' onChange={this.handleChange({inputTitle: 'adjective1'})} />
                    </Col>    
                </Row>
                <Row>
                    <Col md="12">
            ...
            <Col md="3" className="inputWrapper">
                <Row>
                    ...
                    <Col md="10">
                        <input placeholder='Celebrity' type='text' onChange={this.handleChange({inputTitle: 'celebrity1'})} />
                    </Col>    
                </Row>
                <Row>
                    <Col md="12">
